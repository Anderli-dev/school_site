"use strict";
(function(){CKEDITOR.plugins.add("uploadimage",{
        ...
        init:function(b)
        {
            ...
            d.addUploadWidget(b,"uploadimage",
                        {supportedTypes:/image\/(jpeg|png|gif|bmp)/,uploadUrl:c,
            ...
            b.on("paste",function(m)
            {
                ...
                for(g=0;g<j.count(); g++)
                {
                    ...
                    if(k&&e&&!f.data("cke-upload-id")&&!f.isReadOnly(1))
                    {
                        ...
                        n.upload(c);d.markElement(f,"uploadimage",n.id);d.bindNotifications(b,n)
                    }
                }
